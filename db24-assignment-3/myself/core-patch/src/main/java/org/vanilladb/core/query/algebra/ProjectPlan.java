...
public class ProjectPlan implements Plan {
	...
	/**
     * Returns a list containing the child plan of this project plan.
     * 
     * @return a list containing the child plan
     */
    @Override
	...
	/**
     * Returns additional information about the project plan.
     * In this case, it returns the projected fields as a string.
     * 
     * @return the projected fields as a string
     */
    @Override
    public String dumpOptInfo() {
        return "Projected Fields: " + String.join(", ", projectedFields);
    }
}
