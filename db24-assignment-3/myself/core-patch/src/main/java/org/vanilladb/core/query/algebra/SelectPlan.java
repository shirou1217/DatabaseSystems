...
public class SelectPlan extends ReduceRecordsPlan {
	...
	/**
     * Returns a list containing the child plan of this select plan.
     * 
    ...
    /**
     * Returns additional information about the select plan.
     * In this case, it returns the predicate as a string.
     * 
     * @return the predicate as a string
     */
    @Override
    public String dumpOptInfo() {
        return "Predicate: " + pred.toString();
    }
}
