...
public class TablePlan implements Plan {
	...
	/**
     * Returns an empty list since a table plan does not have child plans.
     * 
    ...
    /**
     * Returns additional information about the table plan.
     * In this case, it returns the name of the table.
     * 
     * @return the name of the table
     */
    @Override
    public String dumpOptInfo() {
        return "Table Name: " + ti.fileName();
    }
}
